...
//  * FavouritesPanel
//  *
//  * Shows the user's saved hawker centres.
//  * Clicking a favourite flies the map to it (same as the main list).
//  * Clicking the trash icon removes it from favourites.
//  */
// import { REGION_COLORS } from '../../utils/regionMapper'


// export default function FavouritesPanel({
//   hawkers,          // full hawker list — used to look up full details by id
//   favourites,       // Set<number>
//   onToggleFavourite, // fn(hawker) — removes when called on existing favourite
//   onSelect,         // fn(hawker) — flies map to this hawker
//   selectedId,
// }) {
//   // Build full hawker objects for each favourited id
//   const favouriteHawkers = [...favourites]
//     .map(id => hawkers.find(h => h.id === id))
//     .filter(Boolean)
...
//           <li key={h.id}>
//             <div className={`
//               list-item flex items-start gap-2 px-3.5 py-3 rounded-xl border
...
//                   {h.name}
//                 </p>
//                 <p className="text-xs text-hawker-muted mt-0.5 truncate">
//                   {h.address}
//                 </p>
//                 {h.postal && (
//                   <p className="text-[11px] text-hawker-muted/60 mt-0.5">
...
//                 )}
//                 {h.numStalls && (
//                   <p className="text-[11px] text-hawker-muted mt-0.5">
//                     🍽 {h.numStalls} stalls
//                   </p>
//                 )}
//               </button>

//               {/* Right side: region badge + remove button */}
...
//                   onClick={() => onToggleFavourite(h)}
//                   title="Remove from favourites"
//                   className="text-hawker-red hover:text-red-700 transition-colors text-base leading-none"
//                 >
//                   ♥
//                 </button>
//               </div>
